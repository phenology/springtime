...
def _project_bbox(user_lon:Iterable[float] , user_lat:Iterable[float]) -> Tuple(Iterable[float], Iterable[float]):
    ...
    Returns:
        (np.array, np.array): converted coordinates in daymet projection.
    """
    daymet_proj =(
